...
(function (b) {
    ...
    b.extend(b.jgrid, {
        version: "4.5.2", htmlDecode: function (b) {
            ...
            if (f && null != f)if (!isNaN(f - 0) && "u" === ("" + d).toLowerCase())h = new Date(parseFloat(f)); else if (f.constructor === Date)h = f; else if (null !== j)h = new Date(parseInt(j[1], 10)), j[3] &&
        ...
        getGridParam: function (b) {
            ...
            return this.each(function () {
                ...
                if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function (a) {
                    ...
                    var k = b("td:eq(" + g + ")", h);
                    h = this.formatter(d, c, g, h, "edit"), i = this.p.colModel[g].title ? {title: b.jgrid.stripHtml(h)} : {},
                        this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ? b.unformat.date.call(this, c, h) : c, i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)],
                     void 0 !== i && (this.p.data[i][h.name] = c));
                    "string" === typeof e ? b(k).addClass(e) : e && b(k).css(e);
                    "object" === typeof a && b(k).attr(a);
                    h.editoptions.dataUrl = a.editoptions.dataUrl;
                }
            })
...
(function (a) {
    ...
    a.fn.fmatter.rowactions = function (c) {
        ...
        switch (c) {
            case "edit":
                ...
                j.find("div.ui-inline-edit,div.ui-inline-del,div.icon-zoom-in").hide();
                j.find("div.ui-inline-save,div.ui-inline-cancel").show();
                e.triggerHandler("jqGridAfterGridComplete");
                break;
            case "save":
                e.jqGrid("saveRow", d, b) && (j.find("div.ui-inline-edit,div.ui-inline-del,div.icon-zoom-in").show(), j.find("div.ui-inline-save,div.ui-inline-cancel").hide(), e.triggerHandler("jqGridAfterGridComplete"));
                break;
            case "cancel":
                e.jqGrid("restoreRow", d, k);
                j.find("div.ui-inline-edit,div.ui-inline-del,div.icon-zoom-in").show();
                j.find("div.ui-inline-save,div.ui-inline-cancel").hide();
                e.triggerHandler("jqGridAfterGridComplete");
                break;
            case "del":
            ...
            case "formview":
                e.jqGrid("setSelection", d), e.jqGrid("viewGridRow", d, i.editOptions)
        }
    };
    ...
    //20160628 by happy-sc
    a.fn.fmatter.myaction = function (c, b) {
        var d = {keys: !1, editbutton: !0, viewbutton: !0,editformbutton: !1,}, e = b.rowId, f = "";
        void 0 !== b.colModel.formatoptions && (d = a.extend(d, b.colModel.formatoptions));
        if (void 0 === e || a.fmatter.isEmpty(e))return "";
        d.editformbutton ? f += "<div title='" +
            a.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ") + "><span class='ui-icon ui-icon-pencil'></span></div>" : d.viewbutton && (f += "<div title='" + a.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ") +
            "><span class='ui-icon ui-icon-pencil'></span></div>");

        d.viewbutton && (f += "<div title='" + a.jgrid.nav.viewtitle + "' style='float:left;margin:6px 0 0 5px;' class='ui-pg-div icon-zoom-in grey'" + ("id='jViewButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formview');") + "></div>");
    ...
    //20160715 by happy-sc
    a.fn.fmatter.view = function (c, b) {
        var d = {keys: !1, viewbutton: !0,}, e = b.rowId, f = "";
        void 0 !== b.colModel.formatoptions && (d = a.extend(d, b.colModel.formatoptions));
        if (void 0 === e || a.fmatter.isEmpty(e))return "";
        d.viewbutton && (f += "<div title='" + a.jgrid.nav.viewtitle + "' class='ui-pg-div icon-zoom-in grey'" + ("id='jViewButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formview');") + "></div>");
        return "<div style='margin-left:8px;'>" + f + "</div>"
    };
